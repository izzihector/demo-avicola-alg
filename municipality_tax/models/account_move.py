...
class AccountMoveLine(models.Model):
    ...
    concept_id_2 = fields.Many2one('muni.wh.concept', string='Municipal Tax')
...
class AccountMove(models.Model):
    ...
    def _create_muni_wh_voucher(self):
        ...
        for item in self.invoice_line_ids:
            ...
            impuesto_mun=item.concept_id_2.aliquot
            # fin codigo darrell
    ...
    def unifica_alicuota_iguales(self):
        ...
        for det_tax in lista_impuesto:
            ...
            lista_mov_line = self.env['municipality.tax.line'].search([('invoice_id','=',self.id),('concept_id_2','=',det_tax.id)])
